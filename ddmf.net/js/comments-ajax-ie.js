...
while ( i <= len && got == -1){
	var js_url = document.getElementsByTagName('script')[i].src,
			got = js_url.indexOf('comments-ajax-ie.js'); i++ ;
}
var edit_mode = '1', // 再編輯模式 ( '1'=開; '0'=不開 )
		ajax_php_url = js_url.replace('js/comments-ajax-ie.js', 'includes/comments-ajax.php'),
...
$("#pagenavi a").live("mousedown" , function() {
			if ( edit ) exit_prev_edit();
			var t = addComment, temp = t.I('wp-temp-form-div'), cancel = t.I('cancel-comment-reply-link'), respond = t.I(t.respondId);
