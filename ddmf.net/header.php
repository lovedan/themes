...
<link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/css/danstyle.css" type="text/css" media="screen" />
...
<link rel="icon" type="image/gif" href="<?php bloginfo('template_url'); ?>/images/favicon.png">
...
<?php if (is_home() || is_archive() || is_page('likes') || is_page('views') || is_search()) { ?>
<script type="text/javascript" src="<?php bloginfo('template_url'); ?>/js/jquery.waterfall.min.js"></script>
    ...
    <div class="header-background">
        <div class="header-container page-container">
            <span class="user_logged">
                <?php if ( is_user_logged_in() ) : ?>已登录&nbsp;&nbsp;<?php endif; ?><?php wp_loginout(); ?>
                <span class="textline"> | </span>
                <?php wp_register('', ''); ?><?php if ( !is_user_logged_in() ) : ?><a href="<?php bloginfo('url')?>/wp-login.php?action=register" target="_blank" >注册</a><?php endif; ?>
            </span>
