...
<div id="post">
	...
	<?php if (get_option('swt_rolling_img') == 'true') { ?>
	<?php include('includes/show_img.php'); ?>
	<?php } ?>
		...
		<div class="entry_box_h">
			...
			<span class="cat_name_l"><?php single_cat_title(); ?></span>
				<div class="ico"><?php if (get_option('swt_ico') == '显示') { ?><?php include('includes/cat_ico.php'); ?><?php } else { } ?></div>
					<h2><a href="<?php the_permalink() ?>" rel="bookmark" title="详细阅读 <?php the_title_attribute(); ?>"><?php echo cut_str($post->post_title,48); ?></a></h2>
					<div class="info">
